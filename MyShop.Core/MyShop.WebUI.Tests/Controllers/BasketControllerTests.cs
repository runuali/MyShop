...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "rali@yahoo.com", ZipCode="LE3 9RW" });
            IPrincipal fakeUser = new GenericPrincipal(new GenericIdentity("rali@yahoo.com", "Forms"), null);
